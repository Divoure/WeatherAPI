...
public class Function {
    ...
    //  SIIA KOPEERID OMA API VÕTME
    private static final String OPEN_WEATHER_MAP_API = "04188d7e192e06d4e453f9a3743cda00";
    ...
    public static class placeIdTask extends AsyncTask<String, Void, JSONObject> {
        // An injectable asynchronous response that provides means for asynchronous server
        // side response processing.
        public AsyncResponse delegate = null;//Call back interface
        public placeIdTask(AsyncResponse asyncResponse) {
            delegate = asyncResponse;//Assigning call back interfacethrough constructor
        }
        @Override
        /*Is used to perform background computation that can take a long time.
    ...
    public static JSONObject getWeatherJSON(String lat, String lon){
        try {
            // defining the url where the JSON data is acquired
            URL url = new URL(String.format(OPEN_WEATHER_MAP_URL, lat, lon));
            // starting a http connection with openweathermap.org using your api to get access to
            // data
            ...
            // HTTP status codes: 404 Not Found & 200 OK. This value will be 404 if the request was
            // not successful
